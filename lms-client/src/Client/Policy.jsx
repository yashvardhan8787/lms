  ...
  return (
    <section className="bg-gray-100 py-16 px-4 sm:px-6 lg:px-8 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-xl sm:text-4xl md:text-5xl font-bold mb-6 text-center">
          Terms & Conditions
        </h2>
        <p className="mb-6 text-base sm:text-lg md:text-xl lg:text-2xl text-gray-800 leading-relaxed line-clamp-3">
        ...
        <p className="mb-6 text-base sm:text-lg md:text-xl lg:text-2xl text-gray-800 leading-relaxed line-clamp-4">
          ...
          created a platform – to provide new learners with the resources and
          support they need to succeed.
        </p>
        <p className="mb-6 text-base sm:text-lg md:text-xl lg:text-2xl text-gray-800 leading-relaxed line-clamp-4">
          Our website is a treasure trove of informative videos on everything
          from programming basics to advanced techniques. But that's just the
        ...
        <p className="mb-6 text-base sm:text-lg md:text-xl lg:text-2xl text-gray-800 leading-relaxed line-clamp-4">
          At this platform, we believe that price should never be a barrier to
        ...
        <p className="mb-6 text-base sm:text-lg md:text-xl lg:text-2xl text-gray-800 leading-relaxed line-clamp-3">
          This platform is more than just a community – we're a family. Our
