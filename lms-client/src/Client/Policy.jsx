  ...
  return (
    <section className="bg-gray-100 py-16 px-4 sm:px-6 lg:px-8 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-6 text-lg sm:text-xl md:text-2xl leading-relaxed">
          As the founder, developer, and owner, I know firsthand the challenges that come with learning and growing in the field. That's why we have created a platform – to provide new learners with the resources and support they need to succeed.
        </p>
        <p className="mb-6 text-lg sm:text-xl md:text-2xl leading-relaxed">
