      ...
      <div className="flex max-w-5xl w-full bg-white rounded-xl shadow-md">
        ...
        <div className="w-3/4 p-10 space-y-6">
          {activeForm === 'view' ? (
            ...
            // Edit Profile Form
            <EditProfile userData={userData} onUpdate={handleUpdateProfile} onCancel={() => setActiveForm('view')} />
          ) : activeForm === 'password' ? (
            // Change Password Form
            <ChangePassword onPasswordChange={handleChangePassword} onCancel={() => setActiveForm('view')} />
          ) : null}
        </div>
      </div>
    </div>
